 ...
 * @return array
 */
function poa_add_cart_item_data( $cart_item_data, $product_id ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
